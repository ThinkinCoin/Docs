...
The Flat Kick Incentive parameter should be set such that:

```text
Flat Kick Incentive < Liquidation Gas Costs + Vault Creation Gas Costs
```

The combination of liquidations incentives should be set such that the following is true:

```text
Flat Kick Incentive + Proportional Kick Incentive < Liquidation Penalty + Liquidation Gas Costs + Vault Creation Gas Costs
```
