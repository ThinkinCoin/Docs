...
The Liquidation Penalty should always be higher than the sum of liquidation rewards \(
...
\) so as to prevent the farming of incentives, a practice whereby an attacker purposely liquidates their own vaults in order to reap the liquidation rewards.
