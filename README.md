...
The [exchange](exchange/pancakeswap-exchange.md) is automated market maker \(“AMM”\) that allows two tokens to be exchanged on the Binance Smart Chain. 

#### 💸 Earn

On top of that, you can earn CAKE with [yield farms](yield-farming/farms.md), earn SYRUP and CAKE with Staking, and earn even more tokens with [SYRUP pools](syrup-pools/syrup-pool.md).
