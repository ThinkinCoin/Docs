...
### Advantages of Gnosis Safe contracts <a id="advantages-of-gnosis-safe-contracts"></a>
...
### [Set up your own Gnosis Safe Multisig Now](https://gnosis-safe.binance.org/#/welcome) <a id="set-up-your-own-gnosis-safe-multisig-now"></a>

### Projects building with the Gnosis Safe <a id="projects-building-with-the-gnosis-safe"></a>

Please read the list [here](https://docs.gnosis.io/safe/docs/intro_projects/)

### User Guides <a id="user-guides"></a>

#### Create Gnosis Safe <a id="create-gnosis-safe"></a>
...
#### Receive Funds for Multi-sig Wallet <a id="receive-funds-for-multi-sig-wallet"></a>
...
#### Send Funds from Multi-sig Wallet <a id="send-funds-from-multi-sig-wallet"></a>
...
#### Load existing Safe <a id="load-existing-safe"></a>
...
[https://safe-transaction.gnosis.io/](https://safe-transaction.gnosis.io/)
